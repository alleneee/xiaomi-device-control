...
| `xiaomi_camera_add` | 添加/更新摄像头配置 |
| `xiaomi_camera_remove` | 移除摄像头配置 |
| `xiaomi_camera_snapshot` | 从摄像头截取图片 |
...
通过 [Micam](https://github.com/miiot/micam) 或其他 RTSP 桥接服务，可将小米摄像头视频流接入本项目。
